	...
	public static class CycleResults
	{
		...
		public static List<Cycle>  GetCycleList(List<MegaSena> lstMegaSena)
		{
			...
			foreach (MegaSena obj in lstMegaSena)
			{
				...
				if (obj.Bola1 == 1 || obj.Bola2 == 1 || obj.Bola3 == 1 || obj.Bola4 == 1 || obj.Bola5 == 1 || obj.Bola6 == 1) { objCycle.Number01 = true; objCycle.TimesNum01++; objCycle.NumDate01 = obj.DataDoSorteio; } //Add number date
		...
		{
			Console.WriteLine(string.Format("01 - Times: {0}, LastTime: {1}", objCycle.TimesNum01, objCycle.NumDate01));
			Console.WriteLine(string.Format("02 - Times: {0}, LastTime: {1}", objCycle.TimesNum02, objCycle.NumDate02));
			Console.WriteLine(string.Format("03 - Times: {0}, LastTime: {1}", objCycle.TimesNum03, objCycle.NumDate03));
			Console.WriteLine(string.Format("04 - Times: {0}, LastTime: {1}", objCycle.TimesNum04, objCycle.NumDate04));
			Console.WriteLine(string.Format("05 - Times: {0}, LastTime: {1}", objCycle.TimesNum05, objCycle.NumDate05));
			Console.WriteLine(string.Format("06 - Times: {0}, LastTime: {1}", objCycle.TimesNum06, objCycle.NumDate06));
			Console.WriteLine(string.Format("07 - Times: {0}, LastTime: {1}", objCycle.TimesNum07, objCycle.NumDate07));
			Console.WriteLine(string.Format("08 - Times: {0}, LastTime: {1}", objCycle.TimesNum08, objCycle.NumDate08));
			Console.WriteLine(string.Format("09 - Times: {0}, LastTime: {1}", objCycle.TimesNum09, objCycle.NumDate09));
			Console.WriteLine(string.Format("10 - Times: {0}, LastTime: {1}", objCycle.TimesNum10, objCycle.NumDate10));
			Console.WriteLine(string.Format("11 - Times: {0}, LastTime: {1}", objCycle.TimesNum11, objCycle.NumDate11));
			Console.WriteLine(string.Format("12 - Times: {0}, LastTime: {1}", objCycle.TimesNum12, objCycle.NumDate12));
			Console.WriteLine(string.Format("13 - Times: {0}, LastTime: {1}", objCycle.TimesNum13, objCycle.NumDate13));
			Console.WriteLine(string.Format("14 - Times: {0}, LastTime: {1}", objCycle.TimesNum14, objCycle.NumDate14));
			Console.WriteLine(string.Format("15 - Times: {0}, LastTime: {1}", objCycle.TimesNum15, objCycle.NumDate15));
			Console.WriteLine(string.Format("16 - Times: {0}, LastTime: {1}", objCycle.TimesNum16, objCycle.NumDate16));
			Console.WriteLine(string.Format("17 - Times: {0}, LastTime: {1}", objCycle.TimesNum17, objCycle.NumDate17));
			Console.WriteLine(string.Format("18 - Times: {0}, LastTime: {1}", objCycle.TimesNum18, objCycle.NumDate18));
			Console.WriteLine(string.Format("19 - Times: {0}, LastTime: {1}", objCycle.TimesNum19, objCycle.NumDate19));
			Console.WriteLine(string.Format("20 - Times: {0}, LastTime: {1}", objCycle.TimesNum20, objCycle.NumDate20));
			Console.WriteLine(string.Format("21 - Times: {0}, LastTime: {1}", objCycle.TimesNum21, objCycle.NumDate21));
			Console.WriteLine(string.Format("22 - Times: {0}, LastTime: {1}", objCycle.TimesNum22, objCycle.NumDate22));
			Console.WriteLine(string.Format("23 - Times: {0}, LastTime: {1}", objCycle.TimesNum23, objCycle.NumDate23));
			Console.WriteLine(string.Format("24 - Times: {0}, LastTime: {1}", objCycle.TimesNum24, objCycle.NumDate24));
			Console.WriteLine(string.Format("25 - Times: {0}, LastTime: {1}", objCycle.TimesNum25, objCycle.NumDate25));
			Console.WriteLine(string.Format("26 - Times: {0}, LastTime: {1}", objCycle.TimesNum26, objCycle.NumDate26));
			Console.WriteLine(string.Format("27 - Times: {0}, LastTime: {1}", objCycle.TimesNum27, objCycle.NumDate27));
			Console.WriteLine(string.Format("28 - Times: {0}, LastTime: {1}", objCycle.TimesNum28, objCycle.NumDate28));
			Console.WriteLine(string.Format("29 - Times: {0}, LastTime: {1}", objCycle.TimesNum29, objCycle.NumDate29));
			Console.WriteLine(string.Format("30 - Times: {0}, LastTime: {1}", objCycle.TimesNum30, objCycle.NumDate30));
			Console.WriteLine(string.Format("31 - Times: {0}, LastTime: {1}", objCycle.TimesNum31, objCycle.NumDate31));
			Console.WriteLine(string.Format("32 - Times: {0}, LastTime: {1}", objCycle.TimesNum32, objCycle.NumDate32));
			Console.WriteLine(string.Format("33 - Times: {0}, LastTime: {1}", objCycle.TimesNum33, objCycle.NumDate33));
			Console.WriteLine(string.Format("34 - Times: {0}, LastTime: {1}", objCycle.TimesNum34, objCycle.NumDate34));
			Console.WriteLine(string.Format("35 - Times: {0}, LastTime: {1}", objCycle.TimesNum35, objCycle.NumDate35));
			Console.WriteLine(string.Format("36 - Times: {0}, LastTime: {1}", objCycle.TimesNum36, objCycle.NumDate36));
			Console.WriteLine(string.Format("37 - Times: {0}, LastTime: {1}", objCycle.TimesNum37, objCycle.NumDate37));
			Console.WriteLine(string.Format("38 - Times: {0}, LastTime: {1}", objCycle.TimesNum38, objCycle.NumDate38));
			Console.WriteLine(string.Format("39 - Times: {0}, LastTime: {1}", objCycle.TimesNum39, objCycle.NumDate39));
			Console.WriteLine(string.Format("40 - Times: {0}, LastTime: {1}", objCycle.TimesNum40, objCycle.NumDate40));
			Console.WriteLine(string.Format("41 - Times: {0}, LastTime: {1}", objCycle.TimesNum41, objCycle.NumDate41));
			Console.WriteLine(string.Format("42 - Times: {0}, LastTime: {1}", objCycle.TimesNum42, objCycle.NumDate42));
			Console.WriteLine(string.Format("43 - Times: {0}, LastTime: {1}", objCycle.TimesNum43, objCycle.NumDate43));
			Console.WriteLine(string.Format("44 - Times: {0}, LastTime: {1}", objCycle.TimesNum44, objCycle.NumDate44));
			Console.WriteLine(string.Format("45 - Times: {0}, LastTime: {1}", objCycle.TimesNum45, objCycle.NumDate45));
			Console.WriteLine(string.Format("46 - Times: {0}, LastTime: {1}", objCycle.TimesNum46, objCycle.NumDate46));
			Console.WriteLine(string.Format("47 - Times: {0}, LastTime: {1}", objCycle.TimesNum47, objCycle.NumDate47));
			Console.WriteLine(string.Format("48 - Times: {0}, LastTime: {1}", objCycle.TimesNum48, objCycle.NumDate48));
			Console.WriteLine(string.Format("49 - Times: {0}, LastTime: {1}", objCycle.TimesNum49, objCycle.NumDate49));
			Console.WriteLine(string.Format("50 - Times: {0}, LastTime: {1}", objCycle.TimesNum50, objCycle.NumDate50));
			Console.WriteLine(string.Format("51 - Times: {0}, LastTime: {1}", objCycle.TimesNum51, objCycle.NumDate51));
			Console.WriteLine(string.Format("52 - Times: {0}, LastTime: {1}", objCycle.TimesNum52, objCycle.NumDate52));
			Console.WriteLine(string.Format("53 - Times: {0}, LastTime: {1}", objCycle.TimesNum53, objCycle.NumDate53));
			Console.WriteLine(string.Format("54 - Times: {0}, LastTime: {1}", objCycle.TimesNum54, objCycle.NumDate54));
			Console.WriteLine(string.Format("55 - Times: {0}, LastTime: {1}", objCycle.TimesNum55, objCycle.NumDate55));
			Console.WriteLine(string.Format("56 - Times: {0}, LastTime: {1}", objCycle.TimesNum56, objCycle.NumDate56));
			Console.WriteLine(string.Format("57 - Times: {0}, LastTime: {1}", objCycle.TimesNum57, objCycle.NumDate57));
			Console.WriteLine(string.Format("58 - Times: {0}, LastTime: {1}", objCycle.TimesNum58, objCycle.NumDate58));
			Console.WriteLine(string.Format("59 - Times: {0}, LastTime: {1}", objCycle.TimesNum59, objCycle.NumDate59));
			Console.WriteLine(string.Format("60 - Times: {0}, LastTime: {1}", objCycle.TimesNum60, objCycle.NumDate60));
		}
	}
}
